...
exports.setupEventHandler = function (handler) { return function (eventName) { return function (vnode) {
    ...
    if (eventName === 'click') {
        var OFFSET_1 = 3;
        var startPosition_1 = { x: 0, y: 0 };
        var startTime_1 = 0;
        var setupClickHandler = compose_1.default(exports.setupEventHandler(function (event) {
            var mouseEvent = event;
            startPosition_1.x = mouseEvent.clientX;
            startPosition_1.y = mouseEvent.clientY;
            startTime_1 = +new Date;
            return event;
        })('mousedown'), exports.setupEventHandler(function (event) {
            var mouseEvent = event;
            var now = +new Date;
            if (Math.abs(mouseEvent.clientX - startPosition_1.x) < OFFSET_1
                && Math.abs(mouseEvent.clientY - startPosition_1.y) < OFFSET_1
                && now - startTime_1 < 100) {
...
exports.toViewBox = function (x, y, width, height) {
...
exports.imagePath = function (iconName) { return "/static/images/" + iconName + ".png"; };
